...
import FadeIn from '../framerMotions/fadeIn';

export default memo(function Footer() {
  return (
    <FadeIn bounce={0}>
      <footer className="z-50 text-sm text-black/70 dark:text-white/70">
        <div className="mx-auto mb-0 flex flex-wrap items-center gap-1 px-52 pt-40 pb-20">
          <div>
            ...
            <div className="mt-5 flex items-center">
              ...
              <a
                ...
                href="https://github.com/jianhuagao/cloveui?tab=MIT-1-ov-file"
              >
                MIT License
              </a>
          ...
          <div className="ml-auto grid grid-cols-2 gap-16">
            ...
            <div>
              ...
              <ul className="leading-5 opacity-60">
                ...
                <li>
                  <a
                    href="mailto:jianhua.gao@foxmail.com"
